...
<div class="header-center-section d-none d-lg-block">
    ...
    <div class="logo">
    <a href="index-2.html">
    <img src="{{ asset('asset/website') }}/assets/images/logos/logo.webp" alt="logo">
    </a>
    </div>
  ...
  @livewire('website.wishlist.wishlist-counter')
    </div>
    ...
    <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-1.webp" alt="img">
    </div>
    ...
    <div class="wrapper-item">
    <div class="wrapper-img">
    <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-2.webp" alt="img">
    </div>
    <div class="wrapper-content">
    ...
    <div class="wrapper-item">
    <div class="wrapper-img">
    <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-3.webp" alt="img">
    </div>
    <div class="wrapper-content">
    ...
    <div class="wrapper-item">
    <div class="wrapper-img">
    <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-4.webp" alt="img">
    </div>
    <div class="wrapper-content">
...
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/dresses.webp" alt="dress">
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/bags.webp" alt="Bags">
</span>
<span class="dropdown-text">
Bags
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/sweaters.webp" alt="sweaters">
</span>
<span class="dropdown-text">
Sweaters
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/shoes.webp" alt="sweaters">
</span>
<span class="dropdown-text">
Boots
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/gift.webp" alt="gift">
</span>
<span class="dropdown-text">
Gifts
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/sneakers.webp" alt="sneakers">
</span>
<span class="dropdown-text">
Sneakers
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/watch.webp" alt="watch">
</span>
<span class="dropdown-text">
Watches
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/ring.webp" alt="ring">
</span>
<span class="dropdown-text">
Gold Ring
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/cap.webp" alt="cap">
</span>
<span class="dropdown-text">
Cap
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/glass.webp" alt="glass">
</span>
<span class="dropdown-text">
Sunglasses
</span>
...
<div class="dropdown-list-item d-flex">
<span class="dropdown-img">
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/category-img/baby.webp" alt="baby">
</span>
<span class="dropdown-text">
Baby Shop
</span>
...
<img src="{{ asset('asset/website') }}/assets/images/homepage-one/empty-wishlist.webp" alt="img">
</div>
</div>
</li>
<li>
