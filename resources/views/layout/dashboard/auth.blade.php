...
<head>
  ...
  <title>{{ __('auth.dashboard') }} | @yield('title')
  </title>
  ...
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
  <link rel="stylesheet" type="text/css" href="{{asset('asset/dashboard')}}/css/style-rtl.css">
  <style>
    .fl-wrapper{
    top: 70px !important;
}
...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
  ...
  <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-dark navbar-shadow">
    ...
    <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#"
       ...
       <i class="flag-icon flag-icon-{{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'eg' : 'gb' }}"></i>
