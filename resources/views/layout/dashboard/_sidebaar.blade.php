 <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
       ...
       @endcan
       @can('coupons')
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">coupons</span><span class="badge badge-info badge-pill float-right mr-2">{{ $coupons_count }}</span></a>
          <ul class="menu-content">
            <li ><a class="menu-item" href="{{ route('dashboard.coupons.index') }}"data-i18n="nav.dash.ecommerce">coupons</a>
            </li>
            {{-- <li><a class="menu-item" href="{{ route('dashboard.coupons.create') }}" data-i18n="nav.dash.crypto">Create Brand</a>
            </li> --}}
       ...
       @endcan
       @can('faqs')
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Faqs</span><span class="badge badge-info badge-pill float-right mr-2">{{ $Faqs_count }}</span></a>
          <ul class="menu-content">
            <li ><a class="menu-item" href="{{ route('dashboard.faqs.index') }}"data-i18n="nav.dash.ecommerce">Faqs</a>
            </li>
            {{-- <li><a class="menu-item" href="{{ route('dashboard.coupons.create') }}" data-i18n="nav.dash.crypto">Create Brand</a>
            </li> --}}
      ...
      @can('roles')
        <li class=" nav-item"><a href="#"><i class="la la-columns"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Roles</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('dashboard.roles.index') }}" data-i18n="nav.page_layouts.1_column">Roles</a>
            </li>
            <li><a class="menu-item" href="{{ route('dashboard.roles.create') }}" data-i18n="nav.page_layouts.2_columns">Add Roles</a>
            </li>
