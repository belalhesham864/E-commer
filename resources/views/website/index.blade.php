            ...
            <div class="swiper-wrapper hero-wrapper">
                @foreach ($sliders as $slider)
                    <div class="swiper-slide hero-slider-one"
                        style="background:url({{ asset($slider->file_name) }}) no-repeat center center; background-size:cover;">
                        <div class="container">
                            <div class="col-lg-6">
                                <div class="wrapper-section" data-aos="fade-up">
                                    <div class="wrapper-info">
                                        ...
                                        <h1 class="wrapper-details">{{ $slider->product_slug }}</h1>
        ...
        <section class="product-category">
            <div class="container">
                <div class="section-title">
                    ...
                    <a href="{{ route('categories.index') }}" class="view">View All</a>
                </div>
        ...
        <section class="product brand" data-aos="fade-up">
            <div class="container">
                <div class="section-title">
                    ...
                    <a href="{{ route('brands.index') }}" class="view">View All</a>
                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="{{ asset($product->images->first()->file_name) }}"
                                            alt="{{ $product->name }}">
                                        ...
                                        <div class="product-cart-items">
                                            <a href="{{ route('product.show', $product->slug) }}" class="cart cart-item">
                                                <span>
                                    ...
                                    @livewire('website.wishlist.wishlist',['product'=>$product,'type'=>'card'],key('wishlist-'.$product->id));
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('product.show', $product->slug) }}" class="product-details">{{ $product->name }}
                                            </a>
                                            <div class="price">
                                                @if ($product->has_variants == 0)
                                                    ...
                                                    @else
                                                        ...
                                                        <span
                                                            class="new-price">{{ $product->getPriceAfterDiscount() }}EGP</span>
                                                    @endif
                                                @else
                        ...
                        @foreach ($HomePageProduct['flashProductTimer'] as $product)
                            <div class="col-lg-3 col-md-6">
                                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('product.show', $product->slug) }}"
                                                class="product-details">{{ Str::limit($product->title, 30) }}
                                            </a>
                                            <div class="price">
                                                @if ($product->has_variants == 0)
                                                    <span class="price-cut">{{ $product->price }}EGP</span>
                                    ...
                                    <div class="product-cart-btn">
                                        <a href="{{ route('categories.product', $product->category->slug) }}" class="product-btn">{{  $product->category->name }}</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-3.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('asset/website') }}/assets/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                            ...
                            <div class="col-xl-2 col-md-4">
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            <a href="{{ route('product.show', $product->slug) }}"
                                                class="product-details">{{ Str::limit($product->name, 30) }}
                                            </a>
                                            <div class="price">
                                                @if ($product->has_variants == 0)
                                                    <span class="price-cut">{{ $product->price }}EGP</span>
