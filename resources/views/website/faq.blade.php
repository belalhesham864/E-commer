...
<button class="faq-button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse_{{ $faq->id }}" aria-expanded="false" aria-controls="flush-collapse_{{ $faq->id }}">
...
<script>
    document.addEventListener('livewire:init', () => {
       Livewire.on('faq-Quetion-created', (event) => {
            Swal.fire({
       ...
       Livewire.on('faq-Quetion-failed', (event) => {
            Swal.fire({
