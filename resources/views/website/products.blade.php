...
<img src="{{ asset($product->images->first()->file_name) }}" alt="{{ $product->name }}">
...
<a href="{{ route('product.show',$product->slug) }}" class="product-btn">View Details</a>
</div>
</div>
</div>
...
<p class="content-title">Empty!  don’t Found Products </p>
