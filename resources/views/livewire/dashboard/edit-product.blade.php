<div>
    ...
    <form class="form" wire:submit.prevent="firstStepSubmit">
        @csrf
        <div class="form-body ">
            <h4 class="form-section"><i class="fas fa-pen"></i> Edit Product</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="available_for" wire:model.live="available_for"
            ...
            @foreach ($new_images as $key => $image)
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="position-relative">
                        ...
                        <button  type="button"  wire:click="deleteNewImage({{ $key }})"  class="btn btn-danger btn-sm position-absolute"  style="top: 5px; right: 5px;"
                        > <i class="fa fa-trash"></i>
                        </button>
