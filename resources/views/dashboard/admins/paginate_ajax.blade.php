                            ...
                            <td>
                                ...
                                <div class="dropdown float-md-right">
                                    <button class="btn btn-danger dropdown-toggle round btn-glow px-2" type="button"
                                        id="dropdownActions{{ $admin->id }}" data-toggle="dropdown"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <a class="dropdown-item text-danger modal-effect" data-effect="effect-scale"
                                            data-toggle="modal
           href="#delete{{ $admin->id }}">
                                            <i class="ft-trash mr-1"></i> {{ __('words.delete') }}
                                        </a>
                                        <a class="dropdown-item text-secondary modal-effect" data-effect="effect-scale"
                                            data-toggle="modal" href="#status{{ $admin->id }}">
