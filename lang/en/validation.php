...
return [
    ...
    */
    ...
    'doesnt_contain' => ' :attribute field must not contain any of the following: :values.',
    ...
    'encoding' => ' :attribute field must be encoded in :encoding.',
    ...
    */
    ...
    'attributes' => [
        ...
        'name.ar'=>"role name with arabic",
        'name.en'=>  "role name with english",
    ],
